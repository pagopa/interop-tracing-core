...
export const mockTracingRecords: TracingRecordSchema[] = [
  {
    ...
    status: 200,
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEyMywiZXhwIjoxNjg4MjgyMDAwfQ.nE1Q5tyVjloA5ZRohptDlTfKmj0RRYKcD1hwKsXQgWg",
    requests_count: "10",
    rowNumber: 1,
  },
  {
    ...
    status: 204,
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEyMywiZXhwIjoxNjg4MjgyMDAwfQ.nE1Q5tyVjloA5ZRohptDlTfKmj0RRYKcD1hwKsXQgWf",
    requests_count: "5",
    rowNumber: 2,
  },
  {
    ...
    status: 404,
    token:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEyMywiZXhwIjoxNjg4MjgyMDAwfQ.nE1Q5tyVjloA5ZRohptDlTfKmj0RRYKcD1hwKsXQgWd",
    requests_count: "50",
    rowNumber: 3,
  },
];
...
export const validEnrichedPurpose = [
  {
    ...
    requestsCount: 10,
    tracingId: "87dcfab8-3161-430b-97db-7787a77a7a3d",
    token: "eyF12fahuh1i1421.wsirj1i341",
